        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-6 sm:gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 max-w-xs">
              The complete platform for industrial carbon intelligence.
              Track, analyze, trade, and comply - all in one place.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="w-9 h-9 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-emerald-100 hover:text-emerald-600 dark:hover:bg-emerald-900/50 dark:hover:text-emerald-400 transition-colors"
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              © {new Date().getFullYear()} SustainIQ. All rights reserved.
            </p>
